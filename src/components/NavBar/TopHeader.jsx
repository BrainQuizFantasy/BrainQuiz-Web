...
const TopHeader = ({ t }) => {
  ...
  const { menuOpen, handlers, menuOpenOne, handlersOne } =
    CustomHoverDropdown();
                  ...
                  <div>
                    {!guestlogout ? (
                      ...
                      <>
                        ...
                        <span>
                          <Link to={"/auth/sign-up"} className="signup">
                            {t("Sign Up")}
                          </Link>
                        </span>
                      </>
