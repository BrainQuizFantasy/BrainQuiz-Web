                            ...
                            <div className="whitebackground pt-3">
                                {(() => {
                                    if (showScore) {
                                        ...
                                        return <ReviewAnswer reviewlevel={false} reportquestions={false} questions={questions} goBack={handleReviewAnswerBack} />;
                                    } else {
                                        return questions && questions.length >= 0 ? (
                                            <Question questions={questions} timerSeconds={TIMER_SECONDS} onOptionClick={handleAnswerOptionClick} onQuestionEnd={onQuestionEnd} showQuestions={true} />
                                        ) : (
