                        ...
                        <div className="morphisam">
                            <div className="whitebackground pt-3">
                                <>
                                    {(() => {
                                        if (showScore) {
                                            return <GroupBattleScore score={score} totalQuestions={questions.length} quizScore={quizScore} playAgain={false} coins={coins} />;
                                        } else {
                                            return questions && questions.length > 0 && questions[0].id !== "" ? (
                                                <GroupQuestions questions={questions} timerSeconds={TIMER_SECONDS} onOptionClick={handleAnswerOptionClick} onQuestionEnd={onQuestionEnd} />
                                            ) : (
