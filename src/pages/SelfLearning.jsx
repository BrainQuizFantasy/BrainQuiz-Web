...
const SelfLearning = ({ t }) => {
        ...
        categoriesApi(
            ...
            (response) => {
                ...
                setCategory({
                    ...
                    selected: filteredCategories[0],
                });
                setLoading(false);
                if (filteredCategories[0].no_of !== "0") {
                    subcategoriesApi(
    ...
    const handleChangeCategory = async (e) => {
        ...
        setCategory({ ...category, selected: el.id });
        setSubCategory([]);
    ...
    const handleStart = () => {
        if (!totalquestions.selected) {
            ...
            navigate({ pathname: "/quiz-play/self-learning/self-learning-play" });
            let data = {
                                            ...
                                            <>
                                                {category.all ? (
                                                    category.all.map((cat_data, key) => {
                                                        ...
                                                        return (
                                                            <option key={key} value={cat_data.id} id={cat_data.id} no_of={cat_data.no_of}>
                                                                {category_name}
                                                            </option>
                                                        );
                                                    })
