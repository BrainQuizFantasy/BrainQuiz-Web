                                ...
                                <div className="col-xl-7 col-lg-8 col-md-12 col-12 border-line">
                                    <div className="card p-4 bottom__card_sec">
                                        ...
                                        <div className="bottom__profile_card">
                                            <div className="row">
                                                {
                                                    systemconfig.quiz_zone_mode == '0' && systemconfig.guess_the_word_question == '0' &&
                                                        systemconfig.audio_mode_question == '0' && systemconfig.maths_quiz_mode == '0' ? null :
                                                        <div className="col-md-6 col-12">
                                                            <div className="bookmark__content common_content">
                                                                <NavLink to={"/profile/bookmark"} className="w-100 d-block">
                                                ...
                                                <div className="col-md-6 col-12">
                                                    <div className="Invite_friends__content common_content">
                                                        <NavLink to={"/profile/invite-friends"} className="w-100 d-block">
                                                ...
                                                {/* adding another rows col here */}
                                                <div className="col-md-6 col-12">
                                                    <div className="tracker_data common_content">
                                                        <NavLink to="/profile/coin-history" className="w-100 d-block">
                                                ...
                                                <div className="col-md-6 col-12">
                                                    <div className="badges common_content">
                                                        <NavLink to="/profile/badges" className="w-100 d-block">
                                                            <span>{t("Badges")}</span>
                                                            <i className="custom-icon">
                                                ...
                                                <div className="col-md-6 col-12">
                                                    <div className="statistics common_content">
                                                        <NavLink to="/profile/statistics" className="w-100 d-block">
                                                ...
                                                <div className="col-md-6 col-12">
                                                    <div className="wallet common_content">
                                                        <NavLink to="/profile/wallet" className="w-100 d-block">
                                                            <span>{t("Wallet")}</span>
                                                            <i className="custom-icon">
                                                                <IoWalletOutline />
                                                            </i>
