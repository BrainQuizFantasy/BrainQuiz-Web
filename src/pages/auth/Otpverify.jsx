            ...
            <div className="row morphisam">
              <div className="col-md-6 col-12">
                <div className="inner__login__img justify-content-center align-items-center d-flex">
                  <img
                    src={process.env.PUBLIC_URL + "/images/login/otp_img.svg"}
                    alt="otp"
                  />
                </div>
              </div>
              <div className="col-md-6 col-12 border-line position-relative">
                <div className="inner__login__form outerline">
                  <h3 className="mb-4 text-uppercase text-start">
                    {t("Otp Verification")}
                  </h3>
                    ...
                    <form className="form text-start" onSubmit={onSubmit}>
                      <div>
                        ...
                        <div className="send-button">
                          ...
                          <Link
                            className="btn btn-dark backlogin"
                            to={"/auth/login"}
                            type="button"
                          >
                            {t("Back to Login")}
                      ...
                      <div className="card p-4 bottom__card_sec">
                        ...
                        >
                          <Form.Check
                            type="checkbox"
                            id="have_refer_code"
                            label="Do you have Refer Code ?"
                            onChange={changeReferCodeCheckbox}
                            value={"code"}
                            name="code"
                          />
                        </Form.Group>
