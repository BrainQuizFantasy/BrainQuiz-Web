...
const MathMania = () => {
    ...
    const handleChangeCategory = (data) => {
        ...
        if (data.no_of !== "0") {
            ...
            navigate({ pathname: "/quiz-play/math-mania/math-mania-play" });
            Loadtempdata(data);
        }
                    ...
                    <div className="row morphisam mb-5">
                        ...
                        <div className="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-12">
                            <div className="right-sec">
                                <Mathmaniaslider getAllData={getAllData} categoryall={category.all} data={subCategory.all} url={`/quiz-play/math-mania/math-mania-play`} selected={subCategory.selected} subloading={subloading} />
                            </div>
                        </div>
                    </div>
                </div>
