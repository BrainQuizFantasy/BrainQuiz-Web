...
const AudioQuestions = ({ t }) => {
    ...
    const handleChangeCategory = (data) => {
        ...
        if (data.no_of != "0") {
            ...
            navigate({ pathname: "/quiz-play/audio-questions/audio-questions-play" });
            Loadtempdata(data);
        }
    };
                    ...
                    <div className="row morphisam mb-5">
                        ...
                        <div className="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-12">
                            <div className="right-sec">
                                <AudioQuestionsSlider getAllData={getAllData} categoryall={category.all} data={subCategory.all} selected={subCategory.selected} url={`/quiz-play/audio-questions/audio-questions-play`} Questionsloader={subloading} />
                            </div>
                        </div>
                    </div>
                </div>
