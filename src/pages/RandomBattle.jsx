...
import { groupbattledata, LoadGroupBattleData, loadShowScoreData } from "../store/reducers/groupbattleSlice";
...
const RandomBattle = ({ t }) => {
    ...
    const createBattleRoomWithBot = async (categoryId, name, profileUrl, uid, roomCode, roomType, entryFee, questionlanguageId) => {
        try {
    ...
    const seconduserfound = () => {
        ...
        navigate({ pathname: "/quiz-play/random-battle/random-play" });
    ...
    const createRoomWithBot = async () => {
        ...
        let data = await createBattleRoomWithBot(category_selected, username, userprofile, useruid, roomCode, "public", entrycoins, languageid);
    ...
    const PlaywithFriend = () => {
        navigate({ pathname: "/quiz-play/random-battle/play-with-friend-battle" });
        let data = {
            category_id: category_selected,
