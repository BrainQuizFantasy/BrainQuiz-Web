...
const Badges = () => {
  ...
  const power_elite_coin =
    badgesdata && badgesdata.data.power_elite.badge_reward;
  ...
  // power elite badge
  useEffect(() => {
    const dataFiltered = Object.values(badgesdata.data).filter(
