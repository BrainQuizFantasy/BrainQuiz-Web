...
const RandomBattle = ({ t }) => {
  ...
  let category_selected =
    systemconfig && systemconfig.battle_random_category_mode == "1"
      ? category.selected
      : "";
  ...
  const questionScreen = (roomcode, catid) => {
    navigate("/quiz-play/random-battle/random-play");
    let data = {
      category_id: catid,
      room_id: roomcode,
      destroy_match: "0",
        ...
        <div className="container">
          <div className="row morphisam">
            ...
            <div className="col-md-6  col-xl-5 col-xxl-6 col-12">
              <img
                src={process.env.PUBLIC_URL + "/images/battle/1vs1battle.svg"}
                alt="1vs1"
                className="onevsoneimg pb-3"
              />
            </div>
              ...
              <Tabs defaultActiveKey="1">
                <TabPane tab={t("Create")} key="1">
                  {(() => {
                    if (
                      systemconfig &&
                      systemconfig.battle_random_category_mode == "1"
                    ) {
                      return (
            ...
            <div className="randomplayer">
              <div className="main_screen">
                <div className="room_code_screen">
                  ...
                  <p>
                    {t("Share this room code to friends and ask them to join")}
                  </p>
                </div>
                ...
                <div className="share">
                  ...
                  <WhatsappShareButton
                    ...
                    title={`Hello,Join a group battle in ${appName}. Go to Group Battle in Quiz Play and join using the code : ${shouldGenerateRoomCode}`}
                  >
                    ...
                    return (
                      <>
                        <div className="vs_image">
                          <img
                            src={
                              process.env.PUBLIC_URL + "/images/battle/vs.svg"
                            }
                            alt="versus"
                            height={100}
                            width={30}
