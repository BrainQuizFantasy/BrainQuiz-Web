...
const UNLOCK_PREMIUM_CATEGORIES = "unlock_premium_category";
...
export const getcreateMultiRoomApi = (
  room_id,
  room_type,
  category,
  no_of_que
...
export const setUserStatisticsApi = (
  questions_answered,
  correct_answers,
  category_id,
  percentage
...
export const getUserBadgesApi = async () => {
  ...
  let response = await axios.post(
    `${process.env.REACT_APP_BASE_URL}/api/` + GET_USER_BADGES,
    requestOptions,
    {
      headers: {
        Authorization:
          user && user.data && user.data.api_token
...
export const setPaymentRequestApi = (
  payment_type,
  payment_address,
  payment_amount,
  coin_used,
